...
public class CalamarAgresivoEntity extends WaterMobEntity {
	...
	public float squidPitch;
	   ...
	   public static boolean func_223365_b(EntityType<CalamarAgresivoEntity> p_223365_0_, IWorld p_223365_1_, SpawnReason reason, BlockPos p_223365_3_, Random p_223365_4_) {
	   ...
	   class MoveRandomGoal extends Goal {
	      private final CalamarAgresivoEntity squid;

	      public MoveRandomGoal(CalamarAgresivoEntity calamarAgresivoEntity) {
	         this.squid = calamarAgresivoEntity;
	      }
